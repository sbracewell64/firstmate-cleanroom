...
The candidate is presented as two auditable commits on that ancestry - the change itself and its recorded review-repair pass - kept separate on purpose so the repair is reviewable against what it repaired rather than folded invisibly into it.
