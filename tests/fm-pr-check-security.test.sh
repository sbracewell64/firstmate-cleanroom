...
test_stage_activation_preserves_registered_poll() {
  ...
  grep -q '^stage_discipline=' "$dir/valid.meta" || fail "stage snapshot lost the typed discipline identity field"
  for bad in 'stage_unrecognized=1' 'stage_pr_extra=1' 'stage_context_extra=1' 'stage_discipline_extra=1' 'stage_evidence_extra=1' \
